...
class NewDarkHomeActivity extends StatefulWidget {
  @override
  _NewDarkHomeActivityState createState() => _NewDarkHomeActivityState();
}

class _NewDarkHomeActivityState extends State<NewDarkHomeActivity> {
          ...
          Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  CalcBtn("AC",30.0,Colors.grey.shade500),
                  CalcBtn("+/-",30.0,Colors.grey.shade500),
                  CalcBtn("%",30.0,Colors.grey.shade500),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  CalcBtn("7",30.0,Colors.grey.shade500),
                  CalcBtn("8",30.0,Colors.grey.shade500),
                  CalcBtn("9",30.0,Colors.grey.shade500),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  CalcBtn("4",30.0,Colors.grey.shade500),
                  CalcBtn("5",30.0,Colors.grey.shade500),
                  CalcBtn("6",30.0,Colors.grey.shade500),
                  CalcBtn("-",50.0,kOrange),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  CalcBtn("1",30.0,Colors.grey.shade500),
                  CalcBtn("2",30.0,Colors.grey.shade500),
                  CalcBtn("3",30.0,Colors.grey.shade500),
                  CalcBtn("+",50.0,kOrange),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  CalcBtn("0",30.0,Colors.grey.shade500),
                  CalcBtn(".",50.0,Colors.grey.shade500),
                  CalcBtn("=",50.0,kOrange),
                ],
              ),
            ],
